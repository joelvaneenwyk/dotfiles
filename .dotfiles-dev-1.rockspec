...
build = {
   ...
   modules = {
      ...
      ["source.windows.clink-completions.completions.attrib"] = "source\\windows\\clink-completions\\completions\\attrib.lua",
      ["source.windows.clink-completions.completions.bat"] = "source\\windows\\clink-completions\\completions\\bat.lua",
      ["source.windows.clink-completions.completions.cmdkey"] = "source\\windows\\clink-completions\\completions\\cmdkey.lua",
      ["source.windows.clink-completions.completions.code"] = "source\\windows\\clink-completions\\completions\\code.lua",
      ["source.windows.clink-completions.completions.colortool"] = "source\\windows\\clink-completions\\completions\\colortool.lua",
      ["source.windows.clink-completions.completions.curl"] = "source\\windows\\clink-completions\\completions\\curl.lua",
      ["source.windows.clink-completions.completions.delta"] = "source\\windows\\clink-completions\\completions\\delta.lua",
      ["source.windows.clink-completions.completions.dirx"] = "source\\windows\\clink-completions\\completions\\dirx.lua",
      ["source.windows.clink-completions.completions.doskey"] = "source\\windows\\clink-completions\\completions\\doskey.lua",
      ["source.windows.clink-completions.completions.eza"] = "source\\windows\\clink-completions\\completions\\eza.lua",
      ["source.windows.clink-completions.completions.fastboot"] = "source\\windows\\clink-completions\\completions\\fastboot.lua",
      ["source.windows.clink-completions.completions.fd"] = "source\\windows\\clink-completions\\completions\\fd.lua",
      ["source.windows.clink-completions.completions.findstr"] = "source\\windows\\clink-completions\\completions\\findstr.lua",
      ["source.windows.clink-completions.completions.grep"] = "source\\windows\\clink-completions\\completions\\grep.lua",
      ["source.windows.clink-completions.completions.gsudo"] = "source\\windows\\clink-completions\\completions\\gsudo.lua",
      ["source.windows.clink-completions.completions.less"] = "source\\windows\\clink-completions\\completions\\less.lua",
      ["source.windows.clink-completions.completions.make"] = "source\\windows\\clink-completions\\completions\\make.lua",
      ["source.windows.clink-completions.completions.nmake"] = "source\\windows\\clink-completions\\completions\\nmake.lua",
      ["source.windows.clink-completions.completions.openssl"] = "source\\windows\\clink-completions\\completions\\openssl.lua",
      ["source.windows.clink-completions.completions.ping"] = "source\\windows\\clink-completions\\completions\\ping.lua",
      ["source.windows.clink-completions.completions.premake5"] = "source\\windows\\clink-completions\\completions\\premake5.lua",
      ["source.windows.clink-completions.completions.rg"] = "source\\windows\\clink-completions\\completions\\rg.lua",
      ["source.windows.clink-completions.completions.robocopy"] = "source\\windows\\clink-completions\\completions\\robocopy.lua",
      ["source.windows.clink-completions.completions.scrcpy"] = "source\\windows\\clink-completions\\completions\\scrcpy.lua",
      ["source.windows.clink-completions.completions.sed"] = "source\\windows\\clink-completions\\completions\\sed.lua",
      ["source.windows.clink-completions.completions.signtool"] = "source\\windows\\clink-completions\\completions\\signtool.lua",
      ["source.windows.clink-completions.completions.sudo"] = "source\\windows\\clink-completions\\completions\\sudo.lua",
      ["source.windows.clink-completions.completions.winget"] = "source\\windows\\clink-completions\\completions\\winget.lua",
      ["source.windows.clink-completions.completions.wt"] = "source\\windows\\clink-completions\\completions\\wt.lua",
      ["source.windows.clink-completions.completions.xcopy"] = "source\\windows\\clink-completions\\completions\\xcopy.lua",
      ...
      ["source.windows.clink-completions.modules.arghelper"] = "source\\windows\\clink-completions\\modules\\arghelper.lua",
      ["source.windows.clink-completions.modules.clink_version"] = "source\\windows\\clink-completions\\modules\\clink_version.lua",
      ...
      ["source.windows.clink-completions.modules.help_parser"] = "source\\windows\\clink-completions\\modules\\help_parser.lua",
      ["source.windows.clink-completions.modules.matchers"] = "source\\windows\\clink-completions\\modules\\matchers.lua",
      ["source.windows.clink-completions.modules.multicharflags"] = "source\\windows\\clink-completions\\modules\\multicharflags.lua",
      ...
      ["source.windows.clink-completions.spec.funclib_spec"] = "source\\windows\\clink-completions\\spec\\funclib_spec.lua",
      ...
      ["source.windows.clink.modules.fzf"] = "source\\windows\\clink\\modules\\fzf.lua",
