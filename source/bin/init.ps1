...
.OUTPUTS
    Whether or not the commad exists and can be executed.
#>
        ...
        if ($null -eq $handler) {
            ...
            if (!$responseMsg.IsCanceled) {
                ...
                if ($response.IsSuccessStatusCode) {
                    $downloadedFileStream = New-Object 'System.IO.FileStream' @($FilePath, [System.IO.FileMode]::Create, [System.IO.FileAccess]::Write, [System.IO.FileShare]::None)
