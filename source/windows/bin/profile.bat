...
:GetEnvironmentState
    ...
    ::-----------------------------------
    goto:$GetEnvironmentStateSplitArgsEnd
    :GetEnvironmentStateSplitArgs
        set "ARG0=%1"
        set "ARG1=%2"
    exit /b
    :$GetEnvironmentStateSplitArgsEnd
    call :GetEnvironmentStateSplitArgs !CMD!
    ...
    :$InitializeProfile
    goto:$GetEnvironmentStateGetRoot
    :GetEnvironmentStateGetRoot
    ...
    exit /b 0
    :$GetEnvironmentStateGetRoot
    call :GetEnvironmentStateGetRoot "%~dp0..\..\..\" "%~dpnx0"
...
:$Main
    ...
    if "%CLINK_INJECTED%"=="1" goto:$ClinkDone
