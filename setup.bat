...
setlocal EnableDelayedExpansion
    ...
    if not defined MSYS_SHELL set "MSYS_SHELL=%USERPROFILE%\.local\msys64\msys2_shell.cmd"
    if not exist "!MSYS_SHELL!" set "MSYS_SHELL=%USERPROFILE%\.local\msys64\msys2_shell.cmd"
